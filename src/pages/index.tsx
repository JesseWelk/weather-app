  ...
  return (
    <div>
      <main style={{
        ...
        <div>
          {showCityName && <h1 style={{ fontSize: "44px", fontWeight: "bold"}}>Hourly Forecast</h1>}
        </div>
        ...
        <div>
          <div>
            {showCityName && <h1 style={{ paddingBottom: "40px", fontSize: "44px", fontWeight: "bold" }}>5 Day Forecast</h1>}
          </div>
